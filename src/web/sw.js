...
// ════════════════════════════════════════════════════════════════
const CACHE_NAME = 'portfolio-cache-20260903-5';
...
const PRECACHE_URLS = [
  ...
  './styles/pages/history.css?v=20260903-2',
  ...
  './features/settings/settings_fetch.js?v=20260903-1',
  ...
  './views/views_history_utils.js?v=20260903-2',
  './views/views_history_state.js?v=20260903-3',
  './views/views_history_pipeline.js?v=20260903-4',
  './views/views_history_render.js?v=20260903-3',
  './views/views_history.js?v=20260903-4',
  './app/event_delegation.js?v=20260903-3',
];
