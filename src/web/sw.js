...
// ════════════════════════════════════════════════════════════════
const CACHE_NAME = 'portfolio-cache-20260911-2';
...
const PRECACHE_URLS = [
  ...
  './styles/components.css?v=20260911-1',
  ...
  './features/settings/settings_fetch.js?v=20260911-1',
  './features/management/mgmt_editor.js?v=20260911-2',
  ...
  './views/views_history_state.js?v=20260907-1',
  './views/views_history_pipeline.js?v=20260909-1',
  './views/views_history_render.js?v=20260907-2',
  './views/views_history.js?v=20260904-6',
  './app/event_delegation.js?v=20260911-1',
];
