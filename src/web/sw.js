...
// ════════════════════════════════════════════════════════════════
const CACHE_NAME = 'portfolio-cache-20260908-1';
...
const PRECACHE_URLS = [
  ...
  './features/settings/settings_fetch.js?v=20260908-1',
  ...
  './views/views_history_pipeline.js?v=20260907-5',
  './views/views_history_render.js?v=20260907-2',
  './views/views_history.js?v=20260904-6',
  './app/event_delegation.js?v=20260907-1',
];
