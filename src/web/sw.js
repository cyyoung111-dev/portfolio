...
// ════════════════════════════════════════════════════════════════
const CACHE_NAME = 'portfolio-cache-20260901-3';
...
const PRECACHE_URLS = [
  ...
  './index.html',
  './manifest.json',
  './styles/base.css?v=20260901-2',
  './shared/theme.js?v=20260831-11',
  ...
  './features/settings/settings.js?v=20260831-9',
  './features/settings/settings_fetch.js?v=20260901-3',
  './features/management/mgmt_editor.js?v=20260901-1',
  './features/dividend/mgmt_div.js?v=20260831-6',
  './views/views_history_benchmark.js?v=20260831-7',
  './app/event_delegation.js?v=20260831-11',
];
