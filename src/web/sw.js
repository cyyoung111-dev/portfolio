...
// ════════════════════════════════════════════════════════════════
const CACHE_NAME = 'portfolio-cache-20260903-6';
...
const PRECACHE_URLS = [
  ...
  './views/views_history_state.js?v=20260903-4',
  './views/views_history_pipeline.js?v=20260903-5',
  './views/views_history_render.js?v=20260903-4',
  './views/views_history.js?v=20260903-4',
  './app/event_delegation.js?v=20260903-4',
];
