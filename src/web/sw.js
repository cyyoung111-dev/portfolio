...
// ════════════════════════════════════════════════════════════════
const CACHE_NAME = 'portfolio-cache-20260921-3';
...
const PRECACHE_URLS = [
  ...
  './features/settings/settings_fetch.js?v=20260921-3',
  './features/management/mgmt_editor.js?v=20260921-3',
  ...
  './views/views_history_pipeline.js?v=20260921-3',
  './views/views_history_render.js?v=20260907-2',
  './views/views_history.js?v=20260917-2',
  './app/event_delegation.js?v=20260921-3',
];
