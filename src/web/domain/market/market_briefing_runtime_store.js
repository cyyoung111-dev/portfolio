...
function ingest(storage,masterApi,normalizerApi,payload,meta){const state=load(storage);state.observations=normalizerApi.ingest(masterApi,state.observations,payload,meta);return save(storage,state);}
...
const api={KEY,empty,parse,load,save,ingest,checkpoint,bridge};if(typeof module!=='undefined'&&module.exports)module.exports=api;global.MarketBriefingRuntimeStore=api;
