                ...
                ${(() => {
                  ...
                  return g.trades.map(t => {
                    ...
                    return `<tr style="border-bottom:1px solid var(--border);background:${isSell?'rgba(239,68,68,.03)':'transparent'}">
                      ...
                      <td style="padding:7px 12px;text-align:right;font-family:monospace;font-size:.78rem">${qty.toLocaleString()}</td>
                      <td style="padding:7px 12px;text-align:right;white-space:nowrap;font-family:monospace;font-size:.78rem;color:${isSell?'var(--red-lt)':'var(--green-lt)'}">
                        ${price.toLocaleString()}원
                      </td>
                      <td style="padding:7px 12px;text-align:right;white-space:nowrap;font-family:monospace;font-size:.78rem">${amount.toLocaleString()}원</td>
